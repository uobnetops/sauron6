...
my %host_form = (
 data=>[
  ...
  {ftype=>1, tag=>'misc', name=>'Misc.', type=>'text', len=>100, empty=>1,
...
my %new_host_form = (
 data=>[
  ...
  {ftype=>2, tag=>'mx_l', name=>'Mail exchanges (MX)',
   type=>['priority','mx','text'], fields=>3, len=>[5,60,20], empty=>[0,0,1],
